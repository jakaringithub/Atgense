...
<head>
	<meta charset="UTF-8">
	<title>Atgense test by jakarin</title>
...
<header>
	...
	<div class="heroe">
		...
		<h1>Atgense test by jakarin</h1>
		<div class="col-12" >
			<a class="btn btn-primary" href="<?php echo site_url('/insert-customer') ?>">Insert</a>
		</div>
		<div>
...
<div class="row col-12">
		...
		<table class="table table-bordered" id="users-list">
			...
			<tbody>
				...
				<tr>
					...
					<td>
					<a href="<?php echo base_url('editnames/'.$customer['customerNumber']);?>" class="btn btn-warning">Edit</a>
					<a href="<?php echo base_url('delete/'.$customer['customerNumber']);?>" class="btn btn-danger">Delete</a>
					</td>
				</tr>
				<?php endforeach; ?>
				<?php endif; ?>
	...
	<div class="col-6">
		<h4>Employee at office in Tokyo</h4>
